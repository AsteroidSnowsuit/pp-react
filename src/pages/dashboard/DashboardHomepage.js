...
export class DashboardHomepage extends Component {
    render() {
        ...
        return (
            <Dashboard>
                <FeatureInformation title="Organisme">
                    <p>Vous pouvez modifier les paramètres de votre organisme.</p>
                    <Link to="/organisme">Mon organisme</Link>
                </FeatureInformation>
                <br />
                <FeatureInformation title="Offres">
                    <p>Vous pouvez ajouter ou modifier des offres de bénévolat.</p>
                    <Link to="/organisme/offres">Mes offres</Link>
                </FeatureInformation>
            </Dashboard>
        )
    }
